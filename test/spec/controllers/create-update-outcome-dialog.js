...
describe('Controller: CreateUpdateOutcomeDialogCtrl', function () {

  // load the controller's module
  beforeEach(module('timelinerApp'));

  var CreateUpdateOutcomeDialogCtrl,
    scope,
    $mdDialog;
  ...
  beforeEach(inject(function ($controller, $rootScope) {
    ...
    CreateUpdateOutcomeDialogCtrl = $controller('CreateUpdateOutcomeDialogCtrl', {
      $scope: scope,
      $mdDialog: $mdDialog,
      project: {
        _id: 'id'
